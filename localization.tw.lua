...
SMARTBUFF_OFT_HIDEIFIDLE     = "閒置時隱藏";
...
SMARTBUFF_OFTT_HIDEIFIDLE    = "沒有待施放的增益時隱藏動作按鈕，有待處理時顯示。";
SMARTBUFF_OFTT_INCOMBAT      = "在單一 Buff 設定中勾選「戰鬥中」的 Buff，會盡力以順序各施放一輪：\n進入戰鬥時一輪；若仍在戰鬥中，戰復後再一輪。\n戰鬥中一般 Buff 邏輯會停用！\n勿加入有冷卻的戰鬥法術 — 會打亂序列。";
...
SMARTBUFF_MSG_CASTSEQUENCE_SUFFIX = "（戰鬥中）";
