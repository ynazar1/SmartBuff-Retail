...
SMARTBUFF_OFT_HIDEIFIDLE     = "Скрывать в простое";
...
SMARTBUFF_OFTT_HIDEIFIDLE    = "Скрывать кнопку, если нет ожидающих баффов; показывать, когда что-то в очереди.";
...
SMARTBUFF_BSTT_COMBATIN      = "Баффать если вы в бою.\nВся логика в бою отключена, пока не включена основная опция «в бою» в окне настроек.";
